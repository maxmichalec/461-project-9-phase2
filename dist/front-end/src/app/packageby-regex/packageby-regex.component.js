...
exports.PackagebyRegexComponent = void 0;
/*
...
let PackagebyRegexComponent = (() => {
    ...
    let _classThis;
    var PackagebyRegexComponent = _classThis = class {
        ...
        getPackageRegEx() {
            this.packages = [];
            this.noMatchesFound = false;
            this.apiService.packageByRegExGet({ 'X-Authorization': this.authHeader, body: this.packageregex }).subscribe(response => {
    ...
    __setFunctionName(_classThis, "PackagebyRegexComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        PackagebyRegexComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PackagebyRegexComponent = _classThis;
})();
exports.PackagebyRegexComponent = PackagebyRegexComponent;

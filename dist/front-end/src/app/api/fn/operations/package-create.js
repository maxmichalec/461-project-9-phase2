...
exports.packageCreate = void 0;
/* tslint:disable */
/* eslint-disable */
const http_1 = require("@angular/common/http");
const operators_1 = require("rxjs/operators");
const request_builder_1 = require("../../request-builder");
function packageCreate(http, rootUrl, params, context) {
    const rb = new request_builder_1.RequestBuilder(rootUrl, packageCreate.PATH, 'post');
    if (params) {

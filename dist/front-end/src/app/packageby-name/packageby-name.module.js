...
exports.PackagebyNameModule = void 0;
...
let PackagebyNameModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({
            declarations: [packageby_name_component_1.PackagebyNameComponent],
            imports: [forms_1.FormsModule, common_1.CommonModule],
            exports: [packageby_name_component_1.PackagebyNameComponent],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var PackagebyNameModule = _classThis = class {
    };
    __setFunctionName(_classThis, "PackagebyNameModule");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        PackagebyNameModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PackagebyNameModule = _classThis;
})();
exports.PackagebyNameModule = PackagebyNameModule;

...
exports.PackagebyNameComponent = void 0;
/*
...
let PackagebyNameComponent = (() => {
    ...
    let _classThis;
    var PackagebyNameComponent = _classThis = class {
        constructor(apiService) {
            this.apiService = apiService;
            this.authHeader = 'YOUR_AUTH_TOKEN_HERE';
            this.packageName = ''; //Input from user; 
            this.packageHistory = []; //Response from the backend
            this.deletePackageResponse = '';
        }
        getPackageHistory() {
            this.apiService.packageByNameGet({ 'X-Authorization': this.authHeader, name: this.packageName }).subscribe(response => {
        ...
        deletePackage() {
            this.apiService.packageByNameDelete({ 'X-Authorization': this.authHeader, name: this.packageName }).subscribe(response => {
    ...
    __setFunctionName(_classThis, "PackagebyNameComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        PackagebyNameComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PackagebyNameComponent = _classThis;
})();
exports.PackagebyNameComponent = PackagebyNameComponent;

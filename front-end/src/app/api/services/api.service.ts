...
export class ApiService extends BaseService {
	...
	packageByNameGet(
		params: PackageByNameGet$Params,
		context?: HttpContext,
	): Observable<Array<PackageHistoryEntry>> {
